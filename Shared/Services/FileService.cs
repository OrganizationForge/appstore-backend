    ...
    where T : class
        ...
        public byte[] ConvertHtmlToPdf(string htmlContent)
        {
            ...
            var pdfDocument = new HtmlToPdfDocument
            {
                ...
                Out = "" // Si quieres guardarlo en disco, coloca la ruta aquí.
            },
                Objects = {
                new ObjectSettings
                {
                    ...
                    FooterSettings = { FontName = "Arial", FontSize = 9, Line = true, Center = "Generated by Append" }
                }
            }
            };

            // Convertir a PDF y devolver como byte[]
